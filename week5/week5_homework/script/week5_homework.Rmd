...
animated_plot <- ggplot(Summarized_df,                      #use summarized_df, 
                        aes(x = date_minute)) +             #assign the x axis by date_minutes
  geom_line(aes(y = mean_temp, color = "Temperature")) +    #create 1st line as the mean temperature
  geom_line(aes(y = mean_sali, color = "Salinity")) +       #create 2nd line as mean salinity
  geom_line(aes(y = mean_press, color = "Pressure")) +      #create 3rd line as mean pressure
  geom_line(aes(y = mean_dept, color = "Depth")) +          #create 4th line as mean depth
  ...
  scale_color_manual(values = c("Temperature" = "red",   #assign mean temperature as red line
                                "Salinity" = "blue",     #assign mean salinity as blue line
                                "Pressure" = "green",    #assign mean pressure as green line
                                "Depth" = "purple")) +   #assign mean depth as purple line
  theme(
...
anim_save(here("week5","week5_homework", "output"))
